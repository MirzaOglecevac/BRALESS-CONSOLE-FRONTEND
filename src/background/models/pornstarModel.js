var PornstarModel = (function(){

    var pornstarModel = function(requestHandler){
        ...
        this.getPornstars = function(){
            requestHandler.getRequest(main.url+main.endpoint, main.request, main.coreAjax, main.thisApp);
        };

        this.getSearchPornstars = function(){
            requestHandler.getRequest(main.url+main.endpoint, main.request, main.coreAjax, main.thisApp);
        };

    }

    return new pornstarModel(RequestHandler);
})();
